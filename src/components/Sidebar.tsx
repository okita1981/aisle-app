...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen bg-slate-900 text-white flex flex-col shadow-xl flex-shrink-0">
      ...
      {/* Aisle Monitor リンク（外部・emergence-monitor が正本） */}
      <div className="px-3 pb-2">
        <a
          href="https://emergence-monitor.aisle-aio.ai"
          target="_blank"
        ...
        >
          <span className="text-lg w-7 text-center flex-shrink-0">📡</span>
          <div className="min-w-0">
            <div className="font-semibold text-xs">Aisle Monitor ↗</div>
            <div className="text-xs text-slate-600 truncate">AI Contact / Monitoring / Crawl Log</div>
          </div>
        </a>
      </div>
